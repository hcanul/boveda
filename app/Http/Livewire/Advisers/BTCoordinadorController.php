...
class BTCoordinadorController extends Component
{
    use WithPagination;
    ...
    {
        if($this->search){
            $data = branch_type_coordinators::where('name', 'like', '%' . $this->search .'%')->paginate($this->pagination);
        }else{
            $data = branch_type_coordinators::orderBy('id', 'asc')->paginate($this->pagination);
        }

        return view('livewire.advisers.coordinador.component', ['data' => $data])
    ...
    public function Store()
    {
        ...
        branch_type_coordinators::create(['name' => $this->name, 'rangeinit'=>$this->rangeinit, 'rangefin' => $this->rangefin]);
    ...
    {
        $branch = branch_type_coordinators::find($id);
    ...
    public function Update()
    {
        ...
        $branch = branch_type_coordinators::find($this->selected_id);
    ...
    public function Destroy(branch_type_coordinators $branch)
    {
