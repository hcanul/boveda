...
namespace App\Http\Livewire\Categorycoordinator;

use App\Models\CategoryCordinator;
use Livewire\Component;
use Livewire\WithPagination;

class CategoryCordinatorController extends Component
{
    use WithPagination;
    ...
    public function mount()
    {
        ...
        $this->componentName = 'Categorias Coordinador';
    }

    public function render()
    {
        if($this->search){
            $data = CategoryCordinator::where('name', 'like', '%' . $this->search .'%')->paginate($this->pagination);
        }else{
            $data = CategoryCordinator::orderBy('id', 'asc')->paginate($this->pagination);
        }

        return view('livewire.categorycoordinator.category-cordinator', ['data'=> $data])
    ...
    public function Update()
    {
        ...
        $categoria = CategoryCordinator::find($this->selected_id);
    ...
    public function Destroy(CategoryCordinator $categoryCordinator)
    {
        $categoryCordinator->delete();
