...
namespace App\Http\Livewire\CategoryManager;

use App\Models\CategoryManager;
use Livewire\Component;
use Livewire\WithPagination;

class CategoryManagerController extends Component
{
    use WithPagination;
    ...
    public function mount()
    {
        ...
        $this->componentName = 'Categorias Gerente';
    }

    public function render()
    {
        if($this->search){
            $data = CategoryManager::where('name', 'like', '%' . $this->search .'%')->paginate($this->pagination);
        }else{
            $data = CategoryManager::orderBy('id', 'asc')->paginate($this->pagination);
        }

        return view('livewire.category-manager.category-manager', ['data'=> $data])
    ...
    public function Editar($id)
    {
        ...
        $categoria = CategoryManager::findOrfail($id);
    ...
    public function Update()
    {
        ...
        $categoria = CategoryManager::find($this->selected_id);
    ...
    public function Destroy(CategoryManager $categoryManager)
    {
