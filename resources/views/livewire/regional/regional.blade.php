<div>
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        {{$item->poralcancemetacoloca}}
                    </td>
                    <td class="px-6 py-4">
                        {{$item->diferenciaclientes}}
                    </td>
                    <td class="px-6 py-4">
                        {{$item->diferenciacartera}}
                    </td>
                    <td class="px-6 py-4">
                        {{$item->bonoclientes}}
                    </td>
                    <td class="px-6 py-4">
                        {{$item->bonoccolocacion}}
                    </td>
                    <td class="px-6 py-4">
                        {{$item->bonoexcelencia}}
                    </td>
    ...
    {{ $data->links()}}
    @include('livewire.regional.form')
</div>
<script>
    function Confirm(id)
    {
