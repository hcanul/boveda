    ...
    <form class="space-y-6">
        <div class="grid grid-cols-1 gap-6 p-6 sm:grid-cols-2">
            ...
            <div>
                ...
                <select id="coordinator_id" wire:model='coordinator_id' class="bg-gray-50 border border-gray-300 text-gray-900 mb-6 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <option selected value="Elegir">Elije un Coordinador</option>
                    @foreach ($coordinators as $coordi)
                        <option value="{{ $coordi->id}}">{{$coordi->name}}</option>
                    @endforeach
                </select>
