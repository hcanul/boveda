<svg width="24px" height="24px" viewBox="0 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <defs>
        ...
        <g id="General" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="SLICES-64px" transform="translate(-270.000000, -400.000000)">

    </g>
            <g id="ICONS" transform="translate(-265.000000, -395.000000)">
                <g id="db-tables-swap" transform="translate(270.000000, 402.000000)">
